            ...
            <div className="mx-auto">
                ...
                <div className="grid grid-cols-1 gap-y-6 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                    {props.users.map((user) => (
                        <div key={user.id_user} className="text-secondary bg-white hover:text-tertiary hover:duration-200 hover:cursor-pointer hover:scale-110 hover:bg-primary hover:pointer group relative border rounded-md p-4 shadow-md">
                            <div className="flex justify-between gap-x-6">
                                <div>
                                    ...
                                    <a className="hover:underline" href={user.email}><strong>Envoyer un email</strong></a>
                                </div>
                                <div>
                                    ...
                                    <a className="hover:underline" href={user.cv_link}><strong>Voir le CV</strong></a>
                                </div>
                            </div>
                        </div>
                    ))}
