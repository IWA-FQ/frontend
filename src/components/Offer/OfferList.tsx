            ...
            <div className="mx-auto">
                ...
                <div className="grid grid-cols-1 gap-y-6 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                    {props.offers.map((offer) => (
                        <div key={offer.id_offer} className="text-secondary bg-white hover:text-tertiary hover:duration-200 hover:cursor-pointer hover:scale-110 hover:bg-primary hover:pointer group relative border rounded-md p-4 shadow-md">
